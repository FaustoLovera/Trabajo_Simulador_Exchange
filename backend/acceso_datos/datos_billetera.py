        ...
        with open(BILLETERA_PATH, "r", encoding="utf-8") as f:
            ...
            for ticker, cantidad_str in datos_cargados.items():
                try:
                    ...
                    print(f"Advertencia: Valor inválido para {ticker} en billetera.json. Se usará 0.")
...
def guardar_billetera(billetera):
    ...
    billetera_serializable = {ticker: str(cantidad) for ticker, cantidad in billetera.items()}
